...
// Solo es para usuarios logueados
verificar_sesion();

// Solo para profes ya que  pueden ver esto
if ($_SESSION['rol_id'] != 2) {
    // Si es alumno o admin tratando de entrar aquí, se saca!!
...
// Consulta Traer solo las materias de este profe
