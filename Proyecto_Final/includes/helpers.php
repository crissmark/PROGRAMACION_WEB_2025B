...
// Iniciamos la sesión aquí para no tener que ponerlo en todos los archivos
session_start();
...
function verificar_sesion() {
    if (!isset($_SESSION['usuario_id'])) {
        // Ajustamos la ruta asumiendo que el proyecto está en /proyecto_integrador
        header("Location: /Proyecto_Final/login.php");
        exit;
    }
}

// Función para limpiar datos (evitar XSS) - Requisito del PDF
